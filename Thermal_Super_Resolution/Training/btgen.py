...
class BatchGenerator:
    ...
    def getBatch(self, bs):
        id = np.random.choice(range(0,self.datalen),bs)
...
if __name__ == '__main__':
    ...
    def foloderLength(folder):
        ...
        return len(paths)
    data_dir = "data"
  #train_lr = "/content/drive/MyDrive/Thermal_Super_Resolution/train_lr"
   # train_hr = "/content/drive/MyDrive/Thermal_Super_Resolution/train_hr"
